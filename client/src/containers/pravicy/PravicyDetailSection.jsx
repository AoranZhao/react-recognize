...
import './PravicyDetailSection.scss';

class PravicyDetailSection extends React.Component {
    constructor(props) {
        super(props);

        this.sectionPravicy = this.sectionPravicy.bind(this);
    }

    sectionPravicy() {
        return <div className="pravicyDetailSection">
            <div className="pravicyDetailText">
    ...
    render() {
        return this.sectionPravicy();
    }
}

export default PravicyDetailSection;